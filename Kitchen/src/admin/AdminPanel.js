...
const AdminPanel = () => {
  ...
  const handleLogin = () => {
    axios
      .post('http://192.168.18.14:3500/user/login', {
        email,
        password,
      })
      .then((response) => {
  ...
  const fetchPendingRequests = () => {
    axios
      .get('http://192.168.18.14:3500/pending')
      .then((response) => {
  ...
  const fetchApprovedRequests = () => {
    axios
      .get('http://192.168.18.14:3500/approved')
      .then((response) => {
        // Set the pending requests in the state
  ...
  const handleApproveRequest = (request) => {
    axios
      .put(`http://192.168.18.14:3500/user/${request._id}/approve`)
      .then((response) => {
      ...
      axios
      .post(`http://192.168.18.14:3500/user/approveRequest`, request)
      .then((res) => {
  ...
  const handleRejectRequest = (userId) => {
    axios
      .put(`http://192.168.18.14:3500/user/${userId}/reject`)
      .then((response) => {
